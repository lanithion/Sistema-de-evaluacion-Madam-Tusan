...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Ingresa tu Sede" class="form-control input-md" type="text">
...
<a href="https://www.madamtusan.com.pe/estatico/nuestrahistoria" target="_blank">Quienes Somos</a>
</div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#login">Acceso Administrador</a></div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">Desarrollador</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Desarrollador</span></h4>
      </div>
     ...
     " width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 ...
		 <div class="col-md-5">
     <a href="https://github.com/lanithion/Sistema-de-evaluaci-n-para-el-desempe-o-del-personal-en-la-empresa-Madam-Tusan." style="color:#202020; font-family:'typo' ; font-size:18px" title="Accede a mi repositorio">Aldalu Loayza Rojas</a>
		...
		<h4 style="font-family:'typo' ">Desarrollador Aldalu Loayza Rojas</h4></div></div>
		</p>
      </div>
